...
<div class="section-empty section-item">
    <div class="google-map map-no-scroll-zoom" style="overflow:hidden; position:relative;">
        <iframe src="https://www.openstreetmap.org/export/embed.html?bbox=6.94,51.02,7.04,51.07&amp;layer=mapnik&amp;marker=51.0459,6.9892" width="100%" height="350" style="border:0;display:block;" allowfullscreen referrerpolicy="no-referrer-when-downgrade" title="Map - Musterstrasse 123, Leverkusen"></iframe>
    ...
    <div class="container content">
        <div class="row">
            <div class="col-md-6">
                ...
                <hr class="space s" />
                <form action="<?php echo htmlspecialchars($base); ?>contact-form" class="form-box form-ajax" method="post" data-email="<?php echo htmlspecialchars($contact_email); ?>">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="email" name="email" placeholder="<?php echo htmlspecialchars(tr('email')); ?>" type="email" class="form-control form-value" required>
                        </div>
                    </div>
                    <hr class="space s" />
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <textarea id="messagge" name="messagge" class="form-control form-value" placeholder="<?php echo htmlspecialchars(tr('Write your message')); ?>" required></textarea>
                            <hr class="space s" />
                            <button class="anima-button btn-border btn-sm btn" type="submit"><i class="fa fa-mail-reply-all"></i><?php echo htmlspecialchars(tr('Send messagge')); ?></button>
                        </div>
                    </div>
            ...
            <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="fa-ul">
                            <li><i class="fa-li fa fa-phone"></i> <a href="tel:+4917640486454">+49 176 40486454</a></li>
                    ...
                    <div class="col-md-6">
                        <ul class="fa-ul">
                            <li><i class="fa-li fa fa-map-marker"></i> Musterstrasse 123, 51371 Leverkusen</li>
                        </ul>
                    </div>
                </div>
                <hr class="space m" />
